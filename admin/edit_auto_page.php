...
<head>
    ...
    <title>编辑自动生成页面</title>
</head>
<body>
    <form action="edit_auto_page.php?id=<?php echo $pageId; ?>" method="post">
        ...
        <input type="text" id="baidu_link" name="baidu_link" value="<?php echo $this->extractLink($page['html'], '百度云盘'); ?>" required><br>
        <label for="quark_link">夸克网盘链接:</label>
        <input type="text" id="quark_link" name="quark_link" value="<?php echo $this->extractLink($page['html'], '夸克网盘'); ?>" required><br>
        <label for="lanzou_link">蓝奏云链接:</label>
        <input type="text" id="lanzou_link" name="lanzou_link" value="<?php echo $this->extractLink($page['html'], '蓝奏云极速下载'); ?>" required><br>
        <label for="yun123_link">123云盘链接:</label>
        <input type="text" id="yun123_link" name="yun123_link" value="<?php echo $this->extractLink($page['html'], '123云盘备份'); ?>" required><br>
        <label for="more_link">更多软件链接:</label>
        <input type="text" id="more_link" name="more_link" value="<?php echo $this->extractLink($page['html'], '更多软件'); ?>" required><br>
